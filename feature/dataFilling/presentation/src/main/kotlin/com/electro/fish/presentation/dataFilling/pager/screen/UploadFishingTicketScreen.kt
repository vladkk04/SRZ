...
@Composable
fun UploadFishingTicketScreen(
    inputFormState: InputFormState,
    fishingTicket: MutableState<Uri>,
    ...
    ImagePickerHandler(
        ...
        onImageSelected = {
            if (it == null) {
                fishingTicket.value = Uri.EMPTY
            } else {
                fishingTicket.value = it
            }
    ...
    Column(
        ...
        if (inputFormState.errorMessages[ProfileSetupInputField.FishingTicketImage] != null) {
            Text(
                text = inputFormState.errorMessages[ProfileSetupInputField.FishingTicketImage]!!,
        ...
        Box(
            ...
            modifier = Modifier
                ...
                .fillMaxHeight(0.3f)
                .dashedBorder(
                    color = if (inputFormState.errorMessages[ProfileSetupInputField.FishingTicketImage] != null) {
            ...
            Column(
                ...
                if (fishingTicket.value != Uri.EMPTY) {
                    Image(
                        painter = rememberAsyncImagePainter(fishingTicket.value),
