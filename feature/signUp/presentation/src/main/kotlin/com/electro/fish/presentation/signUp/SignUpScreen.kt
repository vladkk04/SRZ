...
private fun CenterContent(
    ...
    val newLocalAccountCredentials: () -> NewLocalAccount = {
        NewLocalAccount(
    ...
    AppElevatedLoadingButton(
        ...
        onClick = { onEvent(SignUpEvent.SignUp(newLocalAccountCredentials())) },
        modifier = Modifier
            .fillMaxWidth()
...
private fun TextInputFields(
    ...
    AppOutlinedTextField(
        ...
        modifier = Modifier
            ...
            .onFocusLost {
                ...
                onEvent(SignUpEvent.InputEvent(InputFieldEvent.Validate(newLocalAccountCredentials())))
            }
    )
    ...
    AppOutlinedPasswordTextField(
        ...
        onImeAction = { onEvent(SignUpEvent.SignUp(newLocalAccountCredentials())) },
        modifier = Modifier
            .fillMaxWidth()
            .onFocusLost {
                onEvent(
