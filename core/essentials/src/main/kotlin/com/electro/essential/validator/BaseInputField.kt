...
sealed interface BaseInputField<T : Any> {
    ...
    sealed class TextInputField(
        ...
        override fun validate(value: String): ValidationResult {
            ...
            return when {
                trimmedValue.isEmpty() -> ValidationResult.Error(EmptyInputFieldException(this))
                regex != null && !regex.matches(trimmedValue) -> ValidationResult.Error(InputRegexException(this))
